function [sortedD, toPlotEig] = eigenbehaviorPlotterAfterTSNE_WRRpaper(eig1, eig2, originPoint, centroids, idx, optSorted, sortedInput, windowSize)

ref = zeros(192/windowSize,1);
...
rectangle('Position', [0,0,106,195], 'EdgeColor',[135 206 250 40]./255, 'FaceColor', [135 206 250 40]./255)
hold on;
rectangle('Position', [105.5,0,92,195], 'EdgeColor',[255 165 0 40]./255, 'FaceColor', [255 165 0 40]./255)
rectangle('Position', [197.5,0,85,195], 'EdgeColor',[50 205 50 40]./255, 'FaceColor', [50 205 50 40]./255)
...
hold on;
for i = 1:7
    plot([0 size(eig1,2)+10],[24/windowSize*i+0.3 24/windowSize*i+0.3],'Color', [160 160 160]./256,'LineWidth',1.5);
end
