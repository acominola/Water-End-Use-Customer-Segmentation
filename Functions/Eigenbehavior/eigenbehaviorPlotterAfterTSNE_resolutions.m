function sortedD = eigenbehaviorPlotterAfterTSNE(eig1, eig2, originPoint, centroids, idx, optSorted, sortedInput,windowSize)
...
hold on;
for i = 1:7
    plot([0 size(eig1,2)+10],[24/windowSize*i+0.3 24/windowSize*i+0.3],'k','LineWidth',1.5);
end
